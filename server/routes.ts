...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post('/api/webhook/send', async (req, res) => {
    try {
      const webhookUrl = "https://adie19.app.n8n.cloud/webhook/c915362a-0fca-4f75-aa27-a02b8a94fee0";
  ...
  app.post('/api/webhook/hero', async (req, res) => {
    try {
      ...
      const heroWebhookUrl = "https://adie19.app.n8n.cloud/webhook/c915362a-0fca-4f75-aa27-a02b8a94fee0";
